...
# python engine.py \
#     --api_config='paddle.nn.functional.normalize(x=Tensor([4, 5, 6, 35791395],"float16"), )' \
#     --accuracy=True \
#     >> "${LOG_FILE}" 2>&1
# python engine.py \
#     --api_config='paddle.dist(x=Tensor([10],"float16"), y=Tensor([214748364, 10],"float16"), p=4, )' \
#     --accuracy=True \
#     >> "${LOG_FILE}" 2>&1
